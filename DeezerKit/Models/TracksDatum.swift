...
public struct TracksDatum: Codable {
    ...
    public init(id: Int, readable: Bool, title: String, titleShort: String, titleVersion: String, link: String, duration: Int, rank: Int, explicitLyrics: Bool, explicitContentLyrics: Int, explicitContentCover: Int, preview: String, artist: ArtistElement, type: String) {
        self.id = id
